...
image: /5.make-windows-10-feel-fresh-again/thumbnail.png
alt: Windows 10 Task Manager showing normal memory usage after cleanup on a bright desktop
ogImage: /5.make-windows-10-feel-fresh-again/thumbnail.png
tags:
  - windows-10
  - troubleshooting
  - system-maintenance
...
The [Chris Titus Windows Utility](https://github.com/christitustech/winutil) should already be familiar to many people in IT, haha. It is a popular tool for fine-tuning Windows from one place. I used it to disable a few Windows 10 features I did not need, including Windows Update, Windows Defender, and some others.
